...
template <typename T>
typename set<T>::Node* set<T>::maxNode_(Node* node) {
...
template <typename T>
typename set<T>::Node* set<T>::minNode_(Node* node) {
...
template <typename T>
typename set<T>::Node* set<T>::unbindNode_(Node* node) {
...
template <typename T>
typename set<T>::Node const* set<T>::iteratorDown_(const Node* node) {
...
template <typename T>
typename set<T>::Node const* set<T>::iteratorUp_(const Node* node) {
...
template <typename T>
typename set<T>::Node* set<T>::checkHighBalance_(Node* node) {
...
template <typename T>
bool set<T>::isBlackOrNull_(Node* node) {
...
template <typename T>
void set<T>::deleteRebalance_(Node* node) {
    if(!node) {
        return;
    };
...
template <typename T>
typename set<T>::Node* set<T>::find_(const_reference num, Node* node) {
...
template <typename T>
void set<T>::insertRebalance_(Node* node) {
...
template <typename T>
void set<T>::triangleBalance_(Node* node) {
...
template <typename T>
void set<T>::lineBalance_(Node* node) {
...
template <typename T>
bool set<T>::isRightChild_(const Node* node) {
...
template <typename T>
typename set<T>::Node* set<T>::whoIsUncle_(Node* node) {
...
template <typename T>
void set<T>::recolorNode_(Node* node) {
...
template <typename T>
std::pair< typename set<T>::Node*,bool> set<T>::insert_(value_type num, Node* node, bool color) {

    Node* tmp = nullptr;
    std::pair<set<value_type>::Node*,bool> tmp_node;

    if(node->key == num)
        return std::pair<set<value_type>::Node*,bool> (node,false);

    if(node->key < num) {
        if(node->right)
            //return insert_(num, node->right, color);
            tmp_node = insert_(num, node->right, color);
        else {
            ...
            getHigh_(root);
            //return std::pair<set<value_type>::Node*,bool> (tmp,true);
            tmp_node = std::pair<set<value_type>::Node*,bool> (tmp,true);
        }

    }else {

        if(node->left)
            //return insert_(num, node->left, color);
            tmp_node = insert_(num, node->left, color);
        else {
...
template <typename T>
void set<T>::leftRotation_(Node* rotateNode) {
...
template <typename T>
void set<T>::rightRotation_(Node* rotateNode) {
